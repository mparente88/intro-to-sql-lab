...
--Learned about .percentage from ChatGPT
--by asking how to limit the language known to
--ONLY Italian.
...
FROM cities
JOIN countries ON cities.countrycode = countries.code WHERE countries.continent = 'South America' AND cities.name LIKE 'Serr%';
